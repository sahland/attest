...
claimed. attest ships a validation corpus of **137 hand-labelled cases**
...
On the current corpus every one of the fifteen rules measures **precision 1.0
...
7 automated, 3 partial, 39 manual (of 49 criteria)
```
